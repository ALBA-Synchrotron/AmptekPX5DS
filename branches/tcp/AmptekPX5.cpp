...
//  AutoTune                    |  auto_tune
//  RestartSequentialBuffering  |  restart_sequential_buffering
//  CancelSequentialBuffering   |  cancel_sequential_buffering
//  RequestBuffer               |  request_buffer
//  BufferSpectrum              |  buffer_spectrum
//  SetPredefinedValues         |  set_predefined_values
//  GetPredefinedValues         |  get_predefined_values
//  GetSpectrum                 |  get_spectrum
//  InitializeErrorCounter      |  initialize_error_counter
//  RequestBuffer_Status        |  request_buffer__status
...
//  Con2                     |  Tango::DevString	Scalar
//  BufferingStatus          |  Tango::DevDouble	Scalar
//  Temperature              |  Tango::DevDouble	Scalar
//  CurrentSequentialBuffer  |  Tango::DevDouble	Scalar
//  Counter                  |  Tango::DevDouble	Scalar
//  CountsRoI1               |  Tango::DevULong	Scalar
//  CountsRoI2               |  Tango::DevULong	Scalar
//  CountsRoI3               |  Tango::DevULong	Scalar
//  CountsRoI4               |  Tango::DevULong	Scalar
//  CountsRoI5               |  Tango::DevULong	Scalar
//  CountsRoI6               |  Tango::DevULong	Scalar
//  CountsRoI7               |  Tango::DevULong	Scalar
//  CountsRoI8               |  Tango::DevULong	Scalar
...
void AmptekPX5::delete_device()
{
	...
	delete[] attr_Con2_read;
	delete[] attr_BufferingStatus_read;
	delete[] attr_Temperature_read;
	delete[] attr_CurrentSequentialBuffer_read;
	delete[] attr_Counter_read;
	delete[] attr_CountsRoI1_read;
	delete[] attr_CountsRoI2_read;
	delete[] attr_CountsRoI3_read;
	delete[] attr_CountsRoI4_read;
	delete[] attr_CountsRoI5_read;
	delete[] attr_CountsRoI6_read;
	delete[] attr_CountsRoI7_read;
	delete[] attr_CountsRoI8_read;
...
void AmptekPX5::init_device()
{
	...
	attr_Con2_read = new Tango::DevString[1];
	attr_BufferingStatus_read = new Tango::DevDouble[1];
	attr_Temperature_read = new Tango::DevDouble[1];
	attr_CurrentSequentialBuffer_read = new Tango::DevDouble[1];
	attr_Counter_read = new Tango::DevDouble[1];
	attr_CountsRoI1_read = new Tango::DevULong[1];
	attr_CountsRoI2_read = new Tango::DevULong[1];
	attr_CountsRoI3_read = new Tango::DevULong[1];
	attr_CountsRoI4_read = new Tango::DevULong[1];
	attr_CountsRoI5_read = new Tango::DevULong[1];
	attr_CountsRoI6_read = new Tango::DevULong[1];
	attr_CountsRoI7_read = new Tango::DevULong[1];
	attr_CountsRoI8_read = new Tango::DevULong[1];
	...
	*attr_CountsRoI1_read = 0;
	*attr_CountsRoI2_read = 0;
	*attr_CountsRoI3_read = 0;
	*attr_CountsRoI4_read = 0;
	*attr_CountsRoI5_read = 0;
	*attr_CountsRoI6_read = 0;
	*attr_CountsRoI7_read = 0;
	*attr_CountsRoI8_read = 0;

    try
    {
	ifBufferingMode = false;	//buffering mode or enable/disable (spectrum command not allowed when spectrum acquisition enabled)
	errorValue = 0;	//output value in case of error
...
{
	DEBUG_STREAM << "AmptekPX5::always_executed_hook()  " << device_name << endl;
...
void AmptekPX5::read_attr_hardware(TANGO_UNUSED(vector<long> &attr_list))
{
	...
	for (long i = 0; i < nr_attr; i++){
		...
		if (att_name.compare("AuxOut1") == 0 ) {
	        ...
	        else if(att_name.compare("Con2") == 0){
			DEBUG_STREAM <<"Read Con2" << endl;
			count_cmd ++;
			send_cmd->length(count_cmd);
			cmd.clear();
			cmd = "CON2";
	...
	if(count_cmd != 0){
		...
		for(unsigned long i=0; i< result->length(); i++ ){
			...
			else if(argout.find("CON2")!=string::npos){
				DEBUG_STREAM <<"Result of Con2: " << argout << endl;
				argout.erase(0,5); //cmd+=
				*attr_Con2_read = CORBA::string_dup(argout.c_str());
			}
		}
	delete(result);
	}
	...
	try{
		...
		for (long i = 0; i < nr_attr; i++){
			...
			if (att_name.compare("AuxOut1") == 0 ) {
				...
				Tango::WAttribute &att = dev_attr->get_w_attr_by_name("Con2");
				att.set_write_value(attr_Con2_read);
				this->push_change_event("Con2",attr_Con2_read);
			}
		}
	}
	catch (...){
		DEBUG_STREAM << "AmptekPX5::write_attr_hardware ERROR " << endl;
		delete(send_cmd);
	}
...
void AmptekPX5::write_AcquisitionTime(Tango::WAttribute &attr)
{
	...
	if(w_val>= 0)
	    *attr_AcquisitionTime_read = w_val;	//LR
...
void AmptekPX5::read_FastCount(Tango::Attribute &attr)
{
    ...
    try
    {
        commHandler->sendWithReceive(requestPacket, responsePacket, false, nrOfUdpAttempts);
    }
    catch(AmptekException& e)
    {
    ...
    if (responsePacket->at(PID1) != 0x80 or responsePacket->at(PID2) != 0x01 or responsePacket->at(PID2) == 0xAA)
    {
	...
	attr_FastCount_read[0] = errorValue;
...
void AmptekPX5::read_SlowCount(Tango::Attribute &attr)
{
    ...
    if (responsePacket->at(PID1) != 0x80 or responsePacket->at(PID2) != 0x01 or responsePacket->at(PID2) == 0xAA)
    {
        ...
        interpretAcknowledge(responsePacket, &description);
        ERROR_STREAM << description.str() << endl;
        attr_SlowCount_read[0] = errorValue;
    }else
...
//--------------------------------------------------------
/**
 *	Read attribute Con2 related method
 *	Description: 
 *
 *	Data type:	Tango::DevString
 *	Attr type:	Scalar
 */
//--------------------------------------------------------
void AmptekPX5::read_Con2(Tango::Attribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::read_Con2(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::read_Con2) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_Con2_read);

	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::read_Con2
}
//--------------------------------------------------------
/**
 *	Write attribute Con2 related method
 *	Description: 
 *
 *	Data type:	Tango::DevString
 *	Attr type:	Scalar
 */
//--------------------------------------------------------
void AmptekPX5::write_Con2(Tango::WAttribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::write_Con2(Tango::WAttribute &attr) entering... " << endl;
	//	Retrieve write value
	Tango::DevString	w_val;
	attr.get_write_value(w_val);
	/*----- PROTECTED REGION ID(AmptekPX5::write_Con2) ENABLED START -----*/
	*attr_Con2_read = w_val;

	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::write_Con2
}
//--------------------------------------------------------
/**
 *	Read attribute BufferingStatus related method
 *	Description: 
 *
 *	Data type:	Tango::DevDouble
 *	Attr type:	Scalar
 */
//--------------------------------------------------------
void AmptekPX5::read_BufferingStatus(Tango::Attribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::read_BufferingStatus(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::read_BufferingStatus) ENABLED START -----*/
	//	Set the attribute value
    ...
    requestPacket->calcAndFillChecksum();
    responsePacket = new Packet(MIN_PACKET_LEN);
    DEBUG_STREAM << "AmptekPX5::read_BufferingStatus()  - REQUEST: " << endl << requestPacket->toString();
    this->set_status("Reading buffering status!");
    try
    {
        commHandler->sendWithReceive(requestPacket, responsePacket, false, nrOfUdpAttempts);
    }
    catch(AmptekException& e)
    {
        ...
        Tango::Except::throw_exception(
                static_cast<const char*> ("AMPTEK_ERROR"),
                e.description().c_str(),
                static_cast<const char*> ("AmptekPX5::read_BufferingStatus()"));
    }
    DEBUG_STREAM << "AmptekPX5::read_BufferingStatus()  - RESPONSE: " << endl << responsePacket->toString();

    //validating if response packet corresponds to the request
    if (responsePacket->at(PID1) != 0x80 or responsePacket->at(PID2) != 0x01 or responsePacket->at(PID2) == 0xAA)
    {
	this->set_status("Reading buffering status failed!");
        stringstream description;
        description << "Response of AmptekPX5 is not of correct type. State could not be retrieved.";
        interpretAcknowledge(responsePacket, &description);
        ERROR_STREAM << description.str() << endl;

	attr_BufferingStatus_read[0]=errorValue;	//in case of error
    }else{

	byte byte46 = responsePacket->at(DATA+46);
   	byte state46 = (byte(0b00000010) & byte46);
	if(state46 == 32) attr_BufferingStatus_read[0]=1;
	else attr_BufferingStatus_read[0]=0;
	this->set_status("Reading buffering status finished!");
    }
	//attr_BufferingStatus_read[0] = responsePacket->at(DATA+46);

    delete requestPacket;
    delete responsePacket;

    attr.set_value(attr_BufferingStatus_read);


	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::read_BufferingStatus
}
//--------------------------------------------------------
/**
 ...
 */
//--------------------------------------------------------
void AmptekPX5::read_Temperature(Tango::Attribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::read_Temperature(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::read_Temperature) ENABLED START -----*/
	//	Set the attribute value
    ...
    requestPacket->calcAndFillChecksum();
    responsePacket = new Packet(MIN_PACKET_LEN);
    DEBUG_STREAM << "AmptekPX5::read_Temperature()  - REQUEST: " << endl << requestPacket->toString();
    this->set_status("Reading temperature!");
    try
    {
        commHandler->sendWithReceive(requestPacket, responsePacket, false, nrOfUdpAttempts);
    }
    catch(AmptekException& e)
    {
        ...
        Tango::Except::throw_exception(
                static_cast<const char*> ("AMPTEK_ERROR"),
                e.description().c_str(),
                static_cast<const char*> ("AmptekPX5::read_Temperature() "));
    }
    DEBUG_STREAM << "AmptekPX5::read_Temperature()  - RESPONSE: " << endl << responsePacket->toString();

    //validating if response packet corresponds to the request
    if (responsePacket->at(PID1) != 0x80 or responsePacket->at(PID2) != 0x01 or responsePacket->at(PID1) == 0xAA)
    {
	this->set_status("Reading temperature failed!");
	stringstream description;
        description << "Response of AmptekPX5 is not of correct type. State could not be retrieved.";
        interpretAcknowledge(responsePacket, &description);
	attr_Temperature_read[0]=errorValue;

    }
    else{

    	byte byte32MSB = responsePacket->at(DATA+46);
    	byte state32MSB = (byte(0b00001111) & byte32MSB);

    	attr_Temperature_read[0]= mergeBytes(state32MSB,
                                    	responsePacket->at(DATA+33));	//
	this->set_status("Reading temperature finished!");
    }
	...
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::read_Temperature
}
//--------------------------------------------------------
/**
 *	Read attribute CurrentSequentialBuffer related method
 *	Description: 
 *
 *	Data type:	Tango::DevDouble
 *	Attr type:	Scalar
 */
//--------------------------------------------------------
void AmptekPX5::read_CurrentSequentialBuffer(Tango::Attribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::read_CurrentSequentialBuffer(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::read_CurrentSequentialBuffer) ENABLED START -----*/
	//	Set the attribute value
	Packet* requestPacket;
    Packet* responsePacket;
    requestPacket = new Packet(MIN_PACKET_LEN);
    ...
    requestPacket->calcAndFillChecksum();
    responsePacket = new Packet(MIN_PACKET_LEN);
    DEBUG_STREAM << "AmptekPX5::read_CurrentSequentialBuffer()  - REQUEST: " << endl << requestPacket->toString();
    this->set_status("Reading current sequential buffer!");
    ...
    catch(AmptekException& e)
    {
        ...
        Tango::Except::throw_exception(
                static_cast<const char*> ("AMPTEK_ERROR"),
                e.description().c_str(),
                static_cast<const char*> ("AmptekPX5::read_CurrentSequentialBuffer()"));
    }
    DEBUG_STREAM << "AmptekPX5::read_CurrentSequentialBuffer()  - RESPONSE: " << endl << responsePacket->toString();

    //validating if response packet corresponds to the request
    if (responsePacket->at(PID1) != 0x80 or responsePacket->at(PID2) != 0x01 or responsePacket->at(PID1) == 0xAA)
    {
	this->set_status("Reading current sequential buffer failed!");
        stringstream description;
        description << "Response of AmptekPX5 is not of correct type. State could not be retrieved.";
        interpretAcknowledge(responsePacket, &description);

	attr_CurrentSequentialBuffer_read[0]=errorValue;
    }
    else{
	int responseLen = 1;
	byte byte46MSB = responsePacket->at(DATA+46);
   	byte state46MSB = (byte(0b00000001) & byte46MSB);

	attr_CurrentSequentialBuffer_read[0]= mergeBytes(state46MSB, responsePacket->at(DATA+47));
	this->set_status("Reading current sequential buffer finished!");
	}
	...
	attr.set_value(attr_CurrentSequentialBuffer_read);

	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::read_CurrentSequentialBuffer
}
//--------------------------------------------------------
/**
 ...
 */
//--------------------------------------------------------
void AmptekPX5::read_Counter(Tango::Attribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::read_Counter(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::read_Counter) ENABLED START -----*/
  Packet* requestPacket;
    Packet* responsePacket;
    requestPacket = new Packet(MIN_PACKET_LEN);
    requestPacket->initSync();
    ...
    requestPacket->calcAndFillChecksum();
    responsePacket = new Packet(MIN_PACKET_LEN);
    DEBUG_STREAM << "AmptekPX5::read_Counter()  - REQUEST: " << endl << requestPacket->toString();
    this->set_status("Reading counter value!");
    try
    {
        commHandler->sendWithReceive(requestPacket, responsePacket, false, nrOfUdpAttempts);
    }
    catch(AmptekException& e)
    {
        ...
        Tango::Except::throw_exception(
                static_cast<const char*> ("AMPTEK_ERROR"),
                e.description().c_str(),
                static_cast<const char*> ("AmptekPX5::read_Counter() "));
    }
    DEBUG_STREAM << "AmptekPX5::read_Counter()  - RESPONSE: " << endl << responsePacket->toString();

    //validating if response packet corresponds to the request
    if (responsePacket->at(PID1) != 0x80 or responsePacket->at(PID2) != 0x01 or responsePacket->at(PID1) == 0xAA)
    {
	this->set_status("Reading counter failed!");
	stringstream description;
        description << "Response of AmptekPX5 is not of correct type. State could not be retrieved.";
        interpretAcknowledge(responsePacket, &description);
	attr_Counter_read[0]=errorValue;

    }
    else{

      byte byte8 = responsePacket->at(DATA+8);
      byte byte9 = responsePacket->at(DATA+9);
      byte byte10 = responsePacket->at(DATA+10);
      byte byte11 = responsePacket->at(DATA+11);

    	attr_Counter_read[0]= mergeBytes(byte11, byte10, byte9, byte8);	//
	this->set_status("Reading counter finished!");
    }
	...
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::read_Counter
}
//--------------------------------------------------------
/**
 *	Read attribute CountsRoI1 related method
 *	Description: Counts RoI
 *
 *	Data type:	Tango::DevULong
 *	Attr type:	Scalar
 */
//--------------------------------------------------------
void AmptekPX5::read_CountsRoI1(Tango::Attribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::read_CountsRoI1(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::read_CountsRoI1) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_CountsRoI1_read);
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::read_CountsRoI1
}
//--------------------------------------------------------
/**
 *	Read attribute CountsRoI2 related method
 *	Description: Counts RoI
 *
 *	Data type:	Tango::DevULong
 *	Attr type:	Scalar
 */
//--------------------------------------------------------
void AmptekPX5::read_CountsRoI2(Tango::Attribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::read_CountsRoI2(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::read_CountsRoI2) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_CountsRoI2_read);
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::read_CountsRoI2
}
//--------------------------------------------------------
/**
 *	Read attribute CountsRoI3 related method
 *	Description: Counts RoI
 *
 *	Data type:	Tango::DevULong
 *	Attr type:	Scalar
 */
//--------------------------------------------------------
void AmptekPX5::read_CountsRoI3(Tango::Attribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::read_CountsRoI3(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::read_CountsRoI3) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_CountsRoI3_read);
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::read_CountsRoI3
}
//--------------------------------------------------------
/**
 *	Read attribute CountsRoI4 related method
 *	Description: Counts RoI
 *
 *	Data type:	Tango::DevULong
 *	Attr type:	Scalar
 */
//--------------------------------------------------------
void AmptekPX5::read_CountsRoI4(Tango::Attribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::read_CountsRoI4(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::read_CountsRoI4) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_CountsRoI4_read);
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::read_CountsRoI4
}
//--------------------------------------------------------
/**
 *	Read attribute CountsRoI5 related method
 *	Description: Counts RoI
 *
 *	Data type:	Tango::DevULong
 *	Attr type:	Scalar
 */
//--------------------------------------------------------
void AmptekPX5::read_CountsRoI5(Tango::Attribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::read_CountsRoI5(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::read_CountsRoI5) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_CountsRoI5_read);
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::read_CountsRoI5
}
//--------------------------------------------------------
/**
 *	Read attribute CountsRoI6 related method
 *	Description: Counts RoI
 *
 *	Data type:	Tango::DevULong
 *	Attr type:	Scalar
 */
//--------------------------------------------------------
void AmptekPX5::read_CountsRoI6(Tango::Attribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::read_CountsRoI6(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::read_CountsRoI6) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_CountsRoI6_read);
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::read_CountsRoI6
}
//--------------------------------------------------------
/**
 *	Read attribute CountsRoI7 related method
 *	Description: Counts RoI
 *
 *	Data type:	Tango::DevULong
 *	Attr type:	Scalar
 */
//--------------------------------------------------------
void AmptekPX5::read_CountsRoI7(Tango::Attribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::read_CountsRoI7(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::read_CountsRoI7) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_CountsRoI7_read);
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::read_CountsRoI7
}
//--------------------------------------------------------
/**
 *	Read attribute CountsRoI8 related method
 *	Description: Counts RoI
 *
 *	Data type:	Tango::DevULong
 *	Attr type:	Scalar
 */
//--------------------------------------------------------
void AmptekPX5::read_CountsRoI8(Tango::Attribute &attr)
{
	DEBUG_STREAM << "AmptekPX5::read_CountsRoI8(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::read_CountsRoI8) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_CountsRoI8_read);
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::read_CountsRoI8
}
//--------------------------------------------------------
/**
...
Tango::DevState AmptekPX5::dev_state()
{
    ...
    this->set_status("Reading device state!");

    try
    {
        commHandler->sendWithReceive(requestPacket, responsePacket, true, nrOfUdpAttempts);
    }
    catch(AmptekException& e)
    {
        set_state(Tango::ALARM);
	...
	this->set_status("Reading state failed!");
	argout = get_state();	//default value in case no response is returned
    }else{
   	 byte byte35 = responsePacket->at(DATA+35);
    	byte state = (byte(0b00100000) & byte35);
    	byte byte35PRET = responsePacket->at(DATA+35);
    	byte statePRET = (byte(0b10000000) & byte35PRET);
    	attr_BufferingStatus_read[0] = responsePacket->at(DATA+46);	// LR

    	if (get_state() != Tango::ALARM){
    	    if(state == 32 or attr_BufferingStatus_read[0] != 0){	// LR - attr_BufferingStatus_read[0] != 0
		argout = Tango::MOVING;
		if(attr_BufferingStatus_read[0] != 0) this->ifBufferingMode = true;
		if(statePRET == 32 and attr_AcquisitionTime_read[0] != 0.0){
			argout = Tango::ON;
			this->set_status("Spectrum acquisition stopped!");
		}else this->set_status("Reading device state finished!");

	    }
    	    else{
		argout = Tango::ON;
		this->ifBufferingMode = false;
	    }
    	 }else
    		argout = Tango::ALARM;
    }
 ...
 */
//--------------------------------------------------------
Tango::ConstDevString AmptekPX5::dev_status()
{
	DEBUG_STREAM << "AmptekPX5::Status()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::dev_status) ENABLED START -----*/

	string	status;
	unsigned long long spectrumErrors, stateErrors;
	...
	if(get_status() == ""){
		...
		spectrumErrors = commHandler->readNrOfSpectrumErrors();
		stateErrors = commHandler->readNrOfStateErrors();
		status =  get_status()+"\n Number of errors reading spectrum: "+std::to_string(spectrumErrors)+"\n"+
					" Number of errors reading state: "+std::to_string(stateErrors);
	}
	//	Add your own code

	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::dev_status
...
void AmptekPX5::set_text_configuration(const Tango::DevVarStringArray *argin)
{
    ...
    DEBUG_STREAM << "Response packet!!" << endl;
    responsePacket = new Packet(MIN_PACKET_LEN);
    this->set_status("Writing text configuration!");
    ...
    {
	DEBUG_STREAM << "AmptekExcetion: TEXT CONFIGURATION REQUEST" << endl;
        ERROR_STREAM << e.description() << endl;
	...
	DEBUG_STREAM << "get_text_configuration(): responsePacket data lenght = " << responseLen << endl;
    	DEBUG_STREAM << "set_text_configuration(): Data = " << string(responseData)
                 << "; Lenght of data = " << strlen(responseData) << endl;

	this->set_status("Writing text configuration values failed!");
    }else this->set_status("Writing text configuration finished!");
...
Tango::DevVarStringArray *AmptekPX5::get_text_configuration(const Tango::DevVarStringArray *argin)
{
    ...
    responsePacket = new Packet(MIN_PACKET_LEN);
    this->set_status("Reading text configuration!");
    ...
    if (responsePacket->at(PID1) != 0x82 or responsePacket->at(PID2) != 0x07)
    {
        ...
        this->set_status("Reading text configuration values failed!");
	...
	//(*argout)[0] = "";
      ...
      DEBUG_STREAM << confs.size() << endl;
      argout = new Tango::DevVarStringArray(); //---------------------------------
    	argout->length(confs.size());
    	for(unsigned int i = 0; i < confs.size(); i++){
        cmd = confs[i];
        	//(*argout)[i] = CORBA::string_dup(const_cast<char *>(confs[i].c_str()));
          //(*argout)[i] = CORBA::string_dup(confs[i].c_str());
          (*argout)[i] = CORBA::string_dup(cmd.c_str());
}
	this->set_status("Reading text configuration finished!");
    }
...
void AmptekPX5::enable()
{
    ...
    this->set_status("Spectrum acquisition enabled!");
...
void AmptekPX5::disable()
{
    ...
    {
        ERROR_STREAM << description.str() << endl;
        this->set_status("Disable failed!");
    }else this->set_status("Spectrum acquisition disabled!");
...
void AmptekPX5::clear_spectrum()
{
    ...
    {
        ERROR_STREAM << description.str() << endl;
        this->set_status("Spectrum clearing failed!");
    }else this->set_status("Spectrum cleared!");
...
Tango::DevVarULongArray *AmptekPX5::latch_get_clear_sca()
{
    ...
    *attr_CountsRoI1_read =  buffer[0];
    *attr_CountsRoI2_read =  buffer[1];
    *attr_CountsRoI3_read =  buffer[2];
    *attr_CountsRoI4_read =  buffer[3];
    *attr_CountsRoI5_read =  buffer[4];
    *attr_CountsRoI6_read =  buffer[5];
    *attr_CountsRoI7_read =  buffer[6];
    *attr_CountsRoI8_read =  buffer[7];
...
//--------------------------------------------------------
/**
 *	Command RestartSequentialBuffering related method
 *	Description: This request packet starts (or restarts) the Sequential buffering mode of operation. 
 *               It is required an specific hardware setup (see manual).
 *
 */
//--------------------------------------------------------
void AmptekPX5::restart_sequential_buffering()
{
	DEBUG_STREAM << "AmptekPX5::RestartSequentialBuffering()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::restart_sequential_buffering) ENABLED START -----*/
	this->write_parameter("CON2", "AUXIN2");
  DEBUG_STREAM <<"______________________ 1." << endl;

	//	Add your own code
	Packet* requestPacket = new Packet(MIN_PACKET_LEN);
    requestPacket->initSync();
    requestPacket->setPid1(0xF0);
    requestPacket->setPid2(0x1E);
    DEBUG_STREAM <<"______________________ 2." << endl;
    requestPacket->calcAndFillChecksum();
    DEBUG_STREAM << "AmptekPX5::restart_sequential_buffering()  - REQUEST: " << endl << requestPacket->toString() << endl;
    Packet* responsePacket = new Packet(MIN_PACKET_LEN);

    try
    {DEBUG_STREAM <<"______________________ 3." << endl;
        commHandler->sendWithReceive(requestPacket, responsePacket, false, nrOfUdpAttempts);
        DEBUG_STREAM <<"______________________ 4." << endl;
    }
    catch(AmptekException& e)
    {
        ERROR_STREAM << e.description() << endl;
        Tango::Except::throw_exception(
                static_cast<const char*> ("AMPTEK_ERROR"),
                e.description().c_str(),
                static_cast<const char*> ("AmptekPX5::cancel_sequential_buffering()"));
    }
    DEBUG_STREAM << "AmptekPX5::RestartSequentialBuffering()  - RESPONSE: " << endl << responsePacket->toString() << endl;

    //interpretting acknowledge response
    stringstream description;
    bool ackOK = interpretAcknowledge(responsePacket, &description);
    DEBUG_STREAM <<"______________________ 5." << endl;
    if (!ackOK)
    {
        ERROR_STREAM << description.str() << endl;
        this->set_status("Sequential buffering start failed!");
    }else{
      DEBUG_STREAM <<"______________________ 6." << endl;
	this->set_status("Sequential buffering started!");
	this->ifBufferingMode = true;
    }

    delete requestPacket;
    delete responsePacket;
    DEBUG_STREAM <<"______________________ 7." << endl;



	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::restart_sequential_buffering
}
//--------------------------------------------------------
/**
 *	Command CancelSequentialBuffering related method
 *	Description: This request packet cancels the Sequential buffering mode of operation.
 *               This mode of operation requires an specific hardware setup (see manual).
 *
 */
//--------------------------------------------------------
void AmptekPX5::cancel_sequential_buffering()
{
	DEBUG_STREAM << "AmptekPX5::CancelSequentialBuffering()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::cancel_sequential_buffering) ENABLED START -----*/

	//	Add your own code
	Packet* requestPacket = new Packet(MIN_PACKET_LEN);
    requestPacket->initSync();
    requestPacket->setPid1(0xF0);
    requestPacket->setPid2(0x1F);
    requestPacket->calcAndFillChecksum();
    DEBUG_STREAM << "AmptekPX5::cancel_sequential_buffering()  - REQUEST: " << endl << requestPacket->toString() << endl;
    Packet* responsePacket = new Packet(MIN_PACKET_LEN);
    ...
    DEBUG_STREAM << "AmptekPX5::cancel_sequential_buffering()  - RESPONSE: " << endl << responsePacket->toString() << endl;
    ...
    {
        ERROR_STREAM << description.str() << endl;
        this->set_status("Stopping sequential buffering failed!");
    }else{
	this->set_status("Sequential buffering canceled!");
	this->ifBufferingMode = false;
    }
	...
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::cancel_sequential_buffering
}
//--------------------------------------------------------
/**
 *	Command RequestBuffer related method
 *	Description: This command retrieves a previously buffered spectrum
 *
 *	@param argin 
 *	@returns 
 */
//--------------------------------------------------------
Tango::DevVarLongArray *AmptekPX5::request_buffer(Tango::DevShort argin)
{
	Tango::DevVarLongArray *argout;
	DEBUG_STREAM << "AmptekPX5::RequestBuffer()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::request_buffer) ENABLED START -----*/
    ...
    requestPacket->initSync();
    requestPacket->setPid1(0x02);
    requestPacket->setPid2(0x07);
    int len = 2;
    byte data[len];

    strToMSBandLSB(argin, data);

    requestPacket->setData(data, len);
    requestPacket->calcAndFillChecksum();

    DEBUG_STREAM << "AmptekPX5::RequestBuffer(): REQUEST: "
                 << endl << requestPacket->toString();
    responsePacket = new Packet(MIN_PACKET_LEN);
    int spectrumSize = attr_MCAC_read[0];
    this->set_status("Requesting buffer!");

    try
    {
        commHandler->sendWithReceiveSpectrum(requestPacket, responsePacket,  spectrumSize, nrOfUdpAttempts);
    }
    catch(AmptekException& e)
    {
        ERROR_STREAM << e.description() << endl;
        Tango::Except::throw_exception(
            static_cast<const char*> ("AMPTEK_ERROR"),
            e.description().c_str(),
            static_cast<const char*> ("AmptekPX5::RequestBuffer() - commHandler"));
    }

    DEBUG_STREAM << "AmptekPX5::RequestBuffer(): RESPONSE: " << endl << responsePacket->toString();
    //validating if response packet corresponds to the request

    if(responsePacket->at(PID1) != 0x81 or responsePacket->at(PID1) == 0xAA)
    {
	this->set_status("Request buffer failed!");
        stringstream description;
        description << "Response of AmptekPX5 is not of correct type.";
        interpretAcknowledge(responsePacket, &description);
        ERROR_STREAM << description.str() << endl;
    }else this->set_status("Requesting buffer finished!");
	...
	argout = new Tango::DevVarLongArray();
    	argout->length(spectrumLen);




    for (int dataIdx = 0, spctrIdx = 0; dataIdx < dataLen; dataIdx+=3, spctrIdx++)
        (*argout)[spctrIdx] = mergeBytes(responsePacket->at(dataIdx+DATA+2), \
                                                  responsePacket->at(dataIdx+DATA+1), \
                                              	  responsePacket->at(dataIdx+DATA));
	...
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::request_buffer
	return argout;
}
//--------------------------------------------------------
/**
 *	Command BufferSpectrum related method
 *	Description: Copy current spectrum to the buffer into the buffer slot specified in the
 *               argument. Slot 0 is ovewritten by GetSpectrum or Spectrum readout.
 *
 *	@param argin 
 */
//--------------------------------------------------------
void AmptekPX5::buffer_spectrum(Tango::DevShort argin)
{
	DEBUG_STREAM << "AmptekPX5::BufferSpectrum()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::buffer_spectrum) ENABLED START -----*/
    ...
    DEBUG_STREAM << "AmptekPX5::BufferSpectrum(): REQUEST: "
                 << endl << requestPacket->toString();
    responsePacket = new Packet(MIN_PACKET_LEN);
    this->set_status("Buffer spectrum!");
    ...
    catch(AmptekException& e)
    {
        ...
        Tango::Except::throw_exception(
            static_cast<const char*> ("AMPTEK_ERROR"),
            e.description().c_str(),
            static_cast<const char*> ("AmptekPX5::BufferSpectrum()"));
    }

    DEBUG_STREAM << "AmptekPX5::BufferSpectrum(): RESPONSE: " << endl << responsePacket->toString();
   ...
   //interpretting acknowledge response
    ...
    {
        ERROR_STREAM << description.str() << endl;
        this->set_status("Buffer spectrum failed!");
    }else this->set_status("Buffer spectrum finished!");


    delete requestPacket;
    delete responsePacket;

	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::buffer_spectrum
}
//--------------------------------------------------------
/**
 *	Command SetPredefinedValues related method
 *	Description: 
 *
 */
//--------------------------------------------------------
void AmptekPX5::set_predefined_values()
{
	DEBUG_STREAM << "AmptekPX5::SetPredefinedValues()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::set_predefined_values) ENABLED START -----*/

	try{
	std::vector<std::string> commands = {"CLCK=80","TPEA=4.000","GAIF=1.0980","GAIN=15.998","RESL=204","TFLA=0.200",	//right values
		"TPFA=50","PURE=ON","RTDE=OFF","MCAS=NORM","MCAC=1024","SOFF=OFF","AINP=POS","INOF=DEF",
		"GAIA=13","CUSP=0","PDMD=NORM","THSL=0.585","TLLD=OFF","THFA=8.56","DACO=SHAPED","DACF=50",
		"RTDT=0.00","BLRM=1","BLRD=3","BLRU=0","AUO1=SCA8","PRET=0.5","PRER=OFF","PREC=OFF","PRCL=1",
		"PRCH=8191","HVSE=-110","TECS=220","PAPZ=OFF","PAPS=8.5","SCOE=FA","SCOT=12","SCOG=1","MCSL=1","MCSH=8191",
		"MCST=0.01","AUO2=ICR","TPMO=OFF","GPED=RI","GPIN=AUX1","GPME=ON","GPGA=ON","GPMC=ON","MCAE=OFF","VOLU=OFF","CON1=DAC","CON2=AUXIN2"};
	...
	for(unsigned int i=0; i<commands.size(); i++){
		cmd = commands[i];
		(*send_cmd)[i] = CORBA::string_dup(cmd.c_str());
	}
	this->set_text_configuration(send_cmd);
	delete(send_cmd);
	}
	catch (...){
		DEBUG_STREAM << "Exception in set_predefined_values() "<< endl;
	}

	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::set_predefined_values
}
//--------------------------------------------------------
/**
 *	Command GetPredefinedValues related method
 *	Description: 
 *
 *	@returns 
 */
//--------------------------------------------------------
Tango::DevVarStringArray *AmptekPX5::get_predefined_values()
{
	Tango::DevVarStringArray *argout;
	DEBUG_STREAM << "AmptekPX5::GetPredefinedValues()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::get_predefined_values) ENABLED START -----*/

	std::vector<std::string> commands = {"CLCK","TPEA","GAIF","GAIN","RESL","TFLA",
		"TPFA","PURE","RTDE","MCAS","MCAC","SOFF","AINP","INOF",
		"GAIA","CUSP","PDMD","THSL","TLLD","THFA","DACO","DACF",
		"RTDT","BLRM","BLRD","BLRU","AUO1","PRET","PRER","PREC","PRCL",
		"PRCH","HVSE","TECS","PAPZ","PAPS","SCOE","SCOT","SCOG","MCSL","MCSH",
		"MCST","AUO2","TPMO","GPED","GPIN","GPME","GPGA","GPMC","MCAE","VOLU","CON1","CON2"};
	string cmd;
	Tango::DevVarStringArray *send_cmd, *result;
	...
	DEBUG_STREAM << "before commands  - "<< endl;
	for(unsigned int i=0; i<commands.size(); i++){
		cmd = commands[i];
		(*send_cmd)[i] = CORBA::string_dup(cmd.c_str());
	}
	...
	//response
	argout = new Tango::DevVarStringArray();
    	argout->length(count_cmd);

	result = this->get_text_configuration(send_cmd);


	for(unsigned int i=0; i<commands.size(); i++){
		(*argout)[i] = CORBA::string_dup((*result)[i]);
	}
	...
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::get_predefined_values
	return argout;
}
//--------------------------------------------------------
/**
 *	Command GetSpectrum related method
 *	Description: Take a ?snapshot? of the spectrum
 *
 *	@returns 
 */
//--------------------------------------------------------
Tango::DevVarLongArray *AmptekPX5::get_spectrum()
{
	Tango::DevVarLongArray *argout;
	DEBUG_STREAM << "AmptekPX5::GetSpectrum()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::get_spectrum) ENABLED START -----*/
	this->dev_state();
    if(this->ifBufferingMode == false){	// check if acquisition is finished
	int spectrumSize = attr_MCAC_read[0];
    	Packet* requestPacket;
    	Packet* responsePacket;
    	requestPacket = new Packet(MIN_PACKET_LEN);
	...
	requestPacket->setPid2(0x01);
	requestPacket->calcAndFillChecksum();
    	DEBUG_STREAM << "AmptekPX5::GetSpectrum(): REQUEST: " << endl << requestPacket->toString();
    	responsePacket = new Packet(6);
	this->set_status("Reading spectrum!");
    	try
    	{
        	commHandler->sendWithReceiveSpectrum(requestPacket, responsePacket, spectrumSize, nrOfUdpAttempts);
    	}
    	catch(AmptekException& e)
    	{	DEBUG_STREAM << "e.description() " << endl;
        	ERROR_STREAM << e.description() << endl;
        	commHandler->AmptekCommHandler::errorResponsePacket(responsePacket, spectrumSize, true);
    	}
    	DEBUG_STREAM << "AmptekPX5::GetSpectrum(): RESPONSE: " << endl << responsePacket->toString();
    	//validating if response packet corresponds to the request
    	if(responsePacket->at(PID1) != 0x81 or responsePacket->at(PID1) == 0xAA)
    	{
		this->set_status("Spectrum reading failed!");
        	stringstream description;
        	description << "Response of AmptekPX5 is not of correct type.";
        	interpretAcknowledge(responsePacket, &description);
        	ERROR_STREAM << description.str() << endl;
    	}else this->set_status("Reading spectrum finished!");
    	//copying data into spectrum attr
    	unsigned short dataLen = responsePacket->calcLen();
    	unsigned short spectrumLen = dataLen / 3;
	argout = new Tango::DevVarLongArray();
	...
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::get_spectrum
	return argout;
}
//--------------------------------------------------------
/**
 *	Command InitializeErrorCounter related method
 *	Description: 
 *
 */
//--------------------------------------------------------
void AmptekPX5::initialize_error_counter()
{
	DEBUG_STREAM << "AmptekPX5::InitializeErrorCounter()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::initialize_error_counter) ENABLED START -----*/

	commHandler->initializeNrOfSpectrumErrors();
	commHandler->initializeNrOfStateErrors();

	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::initialize_error_counter
}
//--------------------------------------------------------
/**
 *	Command RequestBuffer_Status related method
 *	Description: Retrieves previously buffered spectrum plus status data
 *
 *	@param argin 
 *	@returns 
 */
//--------------------------------------------------------
Tango::DevVarLongArray *AmptekPX5::request_buffer__status(Tango::DevShort argin)
{
	Tango::DevVarLongArray *argout;
	DEBUG_STREAM << "AmptekPX5::RequestBuffer_Status()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::request_buffer__status) ENABLED START -----*/
  ...
  //	Add your own code
    ...
    DEBUG_STREAM << "AmptekPX5::RequestBuffer__status(): REQUEST: "
                 << endl << requestPacket->toString();
    responsePacket = new Packet(MIN_PACKET_LEN);
    int spectrumSize = attr_MCAC_read[0];
    this->set_status("Requesting buffer with status packet!");
    ...
    catch(AmptekException& e)
    {
        ...
        Tango::Except::throw_exception(
            static_cast<const char*> ("AMPTEK_ERROR"),
            e.description().c_str(),
            static_cast<const char*> ("AmptekPX5::RequestBuffer__status() - commHandler"));
    }

    DEBUG_STREAM << "AmptekPX5::RequestBuffer__status(): RESPONSE: " << endl << responsePacket->toString();
    //validating if response packet corresponds to the request
  ...
  this->set_status("Request buffer failed!");
        ...
        interpretAcknowledge(responsePacket, &description);
        ERROR_STREAM << description.str() << endl;
    }else this->set_status("Requesting buffer with status packet finished!");
    ...
    argout = new Tango::DevVarLongArray();
    argout->length(spectrumLen+1);



    // get the current status info for counter value
    byte byte8 = responsePacket->at(DATA+8);
    byte byte9 = responsePacket->at(DATA+9);
    byte byte10 = responsePacket->at(DATA+10);
    byte byte11 = responsePacket->at(DATA+11);
    ...
    // add slot number as first element of array
    (*argout)[0] = mergeBytes(byte11, byte10, byte9, byte8);
    //DEBUG_STREAM << "_______________________________: "<< arg << endl

    // add spectrum
    for (int dataIdx = 0, spctrIdx = 1; dataIdx < dataLen; dataIdx+=3, spctrIdx++)
        (*argout)[spctrIdx] = mergeBytes(responsePacket->at(dataIdx+DATA+2), \
                                                  responsePacket->at(dataIdx+DATA+1), \
                                                  responsePacket->at(dataIdx+DATA));
  ...
  /*----- PROTECTED REGION END -----*/	//	AmptekPX5::request_buffer__status
	return argout;
}
//--------------------------------------------------------
/**
 *	Command ClearCounter related method
 *	Description: Clear the General Purpose Counter
 *
 */
//--------------------------------------------------------
void AmptekPX5::clear_counter()
{
	DEBUG_STREAM << "AmptekPX5::ClearCounter()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(AmptekPX5::clear_counter) ENABLED START -----*/

  //      Add your own code
  Packet* requestPacket = new Packet(MIN_PACKET_LEN);
  requestPacket->initSync();
  requestPacket->setPid1(0xF0);
  requestPacket->setPid2(0x10);
  requestPacket->calcAndFillChecksum();
  Packet* responsePacket = new Packet(MIN_PACKET_LEN);

  DEBUG_STREAM << "AmptekPX5::ClearCounter() - REQUEST: " << endl << requestPacket->toString() << endl;
  try
  {
    commHandler->sendWithReceive(requestPacket, responsePacket, false, nrOfUdpAttempts);
  }
  catch(AmptekException& e)
  {
    ...
    Tango::Except::throw_exception(
        ...
        DEBUG_STREAM << "AmptekPX5::ClearCounter() - RESPONSE: " << endl << responsePacket->toString() << endl;
  ...
  {
    ERROR_STREAM << description.str() << endl;
    this->set_status("Clearing counter failed!");
  }else this->set_status("Counter cleared!");

  delete requestPacket;
  delete responsePacket;


	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::clear_counter
}
 ...
 */
//--------------------------------------------------------
void* AmptekPX5::Auto_Tune_Thread(void *arg) //Autoset Fast Threshold??
{
	bool error = false;
	...
	try{
        ...
        try
            {
            amptek_klass->commHandler->sendWithReceive(requestPacket, responsePacket,  false, amptek_klass->nrOfUdpAttempts);
            }
        catch(AmptekException& e)
            {
        		delete requestPacket;
