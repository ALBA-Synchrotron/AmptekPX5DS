...
public:
	...
	Tango::DevString	*attr_Con2_read;
	Tango::DevDouble	*attr_BufferingStatus_read;
	Tango::DevDouble	*attr_Temperature_read;
	Tango::DevDouble	*attr_CurrentSequentialBuffer_read;
	Tango::DevDouble	*attr_Counter_read;
...
/**
 *	Attribute Con2 related methods
 *	Description: 
 *
 *	Data type:	Tango::DevString
 *	Attr type:	Scalar
 */
	virtual void read_Con2(Tango::Attribute &attr);
	virtual void write_Con2(Tango::WAttribute &attr);
	virtual bool is_Con2_allowed(Tango::AttReqType type);
/**
 *	Attribute BufferingStatus related methods
 *	Description: 
 *
 *	Data type:	Tango::DevDouble
 *	Attr type:	Scalar
 */
	virtual void read_BufferingStatus(Tango::Attribute &attr);
	virtual bool is_BufferingStatus_allowed(Tango::AttReqType type);
/**
...
/**
 *	Attribute CurrentSequentialBuffer related methods
 *	Description: 
 *
 *	Data type:	Tango::DevDouble
 *	Attr type:	Scalar
 */
	virtual void read_CurrentSequentialBuffer(Tango::Attribute &attr);
	virtual bool is_CurrentSequentialBuffer_allowed(Tango::AttReqType type);
/**
...
public:
	 ...
	 *
	 */
	virtual void restart_sequential_buffering();
	virtual bool is_RestartSequentialBuffering_allowed(const CORBA::Any &any);
	/**
	 ...
	 *
	 */
	virtual void cancel_sequential_buffering();
	virtual bool is_CancelSequentialBuffering_allowed(const CORBA::Any &any);
	/**
	 ...
	 *	@returns 
	 */
	virtual Tango::DevVarLongArray *request_buffer(Tango::DevShort argin);
	virtual bool is_RequestBuffer_allowed(const CORBA::Any &any);
	/**
	 ...
	 *	@param argin 
	 */
	virtual void buffer_spectrum(Tango::DevShort argin);
	virtual bool is_BufferSpectrum_allowed(const CORBA::Any &any);
	/**
	 *	Command SetPredefinedValues related method
	 *	Description: 
	 *
	 */
	virtual void set_predefined_values();
	virtual bool is_SetPredefinedValues_allowed(const CORBA::Any &any);
	/**
	 ...
	 *	@returns 
	 */
	virtual Tango::DevVarStringArray *get_predefined_values();
	virtual bool is_GetPredefinedValues_allowed(const CORBA::Any &any);
	/**
	 ...
	 *	@returns 
	 */
	virtual Tango::DevVarLongArray *get_spectrum();
	virtual bool is_GetSpectrum_allowed(const CORBA::Any &any);
	/**
	 *	Command InitializeErrorCounter related method
	 *	Description: 
	 *
	 */
	virtual void initialize_error_counter();
	virtual bool is_InitializeErrorCounter_allowed(const CORBA::Any &any);
	/**
	 ...
	 *	@returns 
	 */
	virtual Tango::DevVarLongArray *request_buffer__status(Tango::DevShort argin);
	virtual bool is_RequestBuffer_Status_allowed(const CORBA::Any &any);
	/**
	...
	virtual bool is_ClearCounter_allowed(const CORBA::Any &any);
