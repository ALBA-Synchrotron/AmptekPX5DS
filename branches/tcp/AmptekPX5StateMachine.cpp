...
//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_Con2_allowed()
 *	Description : Execution allowed for Con2 attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_Con2_allowed(TANGO_UNUSED(Tango::AttReqType type))
{
	//	Not any excluded states for Con2 attribute in Write access.
	/*----- PROTECTED REGION ID(AmptekPX5::Con2StateAllowed_WRITE) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::Con2StateAllowed_WRITE

	//	Not any excluded states for Con2 attribute in read access.
	/*----- PROTECTED REGION ID(AmptekPX5::Con2StateAllowed_READ) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::Con2StateAllowed_READ
	return true;
}

//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_BufferingStatus_allowed()
 *	Description : Execution allowed for BufferingStatus attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_BufferingStatus_allowed(TANGO_UNUSED(Tango::AttReqType type))
{

	//	Not any excluded states for BufferingStatus attribute in read access.
	/*----- PROTECTED REGION ID(AmptekPX5::BufferingStatusStateAllowed_READ) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::BufferingStatusStateAllowed_READ
	return true;
}

//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_Temperature_allowed()
 *	Description : Execution allowed for Temperature attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_Temperature_allowed(TANGO_UNUSED(Tango::AttReqType type))
{

	//	Not any excluded states for Temperature attribute in read access.
	/*----- PROTECTED REGION ID(AmptekPX5::TemperatureStateAllowed_READ) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::TemperatureStateAllowed_READ
	return true;
}

//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_CurrentSequentialBuffer_allowed()
 *	Description : Execution allowed for CurrentSequentialBuffer attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_CurrentSequentialBuffer_allowed(TANGO_UNUSED(Tango::AttReqType type))
{

	//	Not any excluded states for CurrentSequentialBuffer attribute in read access.
	/*----- PROTECTED REGION ID(AmptekPX5::CurrentSequentialBufferStateAllowed_READ) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::CurrentSequentialBufferStateAllowed_READ
	return true;
}

//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_Counter_allowed()
 *	Description : Execution allowed for Counter attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_Counter_allowed(TANGO_UNUSED(Tango::AttReqType type))
{

	//	Not any excluded states for Counter attribute in read access.
	/*----- PROTECTED REGION ID(AmptekPX5::CounterStateAllowed_READ) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::CounterStateAllowed_READ
	return true;
}
...
//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_RestartSequentialBuffering_allowed()
 *	Description : Execution allowed for RestartSequentialBuffering attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_RestartSequentialBuffering_allowed(TANGO_UNUSED(const CORBA::Any &any))
{
	//	Not any excluded states for RestartSequentialBuffering command.
	/*----- PROTECTED REGION ID(AmptekPX5::RestartSequentialBufferingStateAllowed) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::RestartSequentialBufferingStateAllowed
	return true;
}

//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_CancelSequentialBuffering_allowed()
 *	Description : Execution allowed for CancelSequentialBuffering attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_CancelSequentialBuffering_allowed(TANGO_UNUSED(const CORBA::Any &any))
{
	//	Not any excluded states for CancelSequentialBuffering command.
	/*----- PROTECTED REGION ID(AmptekPX5::CancelSequentialBufferingStateAllowed) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::CancelSequentialBufferingStateAllowed
	return true;
}

//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_RequestBuffer_allowed()
 *	Description : Execution allowed for RequestBuffer attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_RequestBuffer_allowed(TANGO_UNUSED(const CORBA::Any &any))
{
	//	Not any excluded states for RequestBuffer command.
	/*----- PROTECTED REGION ID(AmptekPX5::RequestBufferStateAllowed) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::RequestBufferStateAllowed
	return true;
}

//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_BufferSpectrum_allowed()
 *	Description : Execution allowed for BufferSpectrum attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_BufferSpectrum_allowed(TANGO_UNUSED(const CORBA::Any &any))
{
	//	Not any excluded states for BufferSpectrum command.
	/*----- PROTECTED REGION ID(AmptekPX5::BufferSpectrumStateAllowed) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::BufferSpectrumStateAllowed
	return true;
}

//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_SetPredefinedValues_allowed()
 *	Description : Execution allowed for SetPredefinedValues attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_SetPredefinedValues_allowed(TANGO_UNUSED(const CORBA::Any &any))
{
	//	Not any excluded states for SetPredefinedValues command.
	/*----- PROTECTED REGION ID(AmptekPX5::SetPredefinedValuesStateAllowed) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::SetPredefinedValuesStateAllowed
	return true;
}

//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_GetPredefinedValues_allowed()
 *	Description : Execution allowed for GetPredefinedValues attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_GetPredefinedValues_allowed(TANGO_UNUSED(const CORBA::Any &any))
{
	//	Not any excluded states for GetPredefinedValues command.
	/*----- PROTECTED REGION ID(AmptekPX5::GetPredefinedValuesStateAllowed) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::GetPredefinedValuesStateAllowed
	return true;
}

//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_GetSpectrum_allowed()
 *	Description : Execution allowed for GetSpectrum attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_GetSpectrum_allowed(TANGO_UNUSED(const CORBA::Any &any))
{
	//	Not any excluded states for GetSpectrum command.
	/*----- PROTECTED REGION ID(AmptekPX5::GetSpectrumStateAllowed) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::GetSpectrumStateAllowed
	return true;
}

//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_InitializeErrorCounter_allowed()
 *	Description : Execution allowed for InitializeErrorCounter attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_InitializeErrorCounter_allowed(TANGO_UNUSED(const CORBA::Any &any))
{
	//	Not any excluded states for InitializeErrorCounter command.
	/*----- PROTECTED REGION ID(AmptekPX5::InitializeErrorCounterStateAllowed) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::InitializeErrorCounterStateAllowed
	return true;
}

//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_RequestBuffer_Status_allowed()
 *	Description : Execution allowed for RequestBuffer_Status attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_RequestBuffer_Status_allowed(TANGO_UNUSED(const CORBA::Any &any))
{
	//	Not any excluded states for RequestBuffer_Status command.
	/*----- PROTECTED REGION ID(AmptekPX5::RequestBuffer_StatusStateAllowed) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::RequestBuffer_StatusStateAllowed
	return true;
}

//--------------------------------------------------------
/**
 *	Method      : AmptekPX5::is_ClearCounter_allowed()
 *	Description : Execution allowed for ClearCounter attribute
 */
//--------------------------------------------------------
bool AmptekPX5::is_ClearCounter_allowed(TANGO_UNUSED(const CORBA::Any &any))
{
	//	Not any excluded states for ClearCounter command.
	/*----- PROTECTED REGION ID(AmptekPX5::ClearCounterStateAllowed) ENABLED START -----*/
	
	/*----- PROTECTED REGION END -----*/	//	AmptekPX5::ClearCounterStateAllowed
	return true;
}
