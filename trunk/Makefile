#PROTECTED REGION ID(AmptekPX5::Makefile) ENABLED START#
#=============================================================================
#
# file :        Makefile
#
...
#
#
INC_DIR_USER+= -I$(TANGO_HOME)/include \
		  -I$(TANGO_HOME)/include/tango \
		-I . 
